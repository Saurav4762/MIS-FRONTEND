...
const FAMILY_SECTIONS: FamilySection[] = [
  { id: "member-details", label: "Member Details", link: "/" },
  { id: "social-cultural", label: "Social / Cultural", link: "/" },
  { id: "residence", label: "Residence", link: "/" },
  { id: "economic", label: "Economic", link: "/" },
  { id: "facilities", label: "Facilities", link: "/" },
  { id: "health", label: "Health", link: "/" },
  { id: "agriculture", label: "Agriculture", link: "/" },
  { id: "livestock", label: "Livestock", link: "/" },
  { id: "decision-making", label: "Decision Making", link: "/" },
  { id: "disaster", label: "Disaster", link: "/" },
  { id: "collector", label: "Collector", link: "/" },
];
