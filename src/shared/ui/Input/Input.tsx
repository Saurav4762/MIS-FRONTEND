  ...
  ({ className, hasError = false, ...props }, ref) => {
    return (
      <input
        ref={ref}
        className={cn(
          "w-full rounded-field bg-white px-3 text-normal font-medium text-ink-900 outline-none transition-colors placeholder:font-normal placeholder:text-ink-400",
          hasError
